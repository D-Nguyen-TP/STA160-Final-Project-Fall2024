...
ggplot(dat, mapping = aes(x = Year, y = MAA)) + 
  ...
  labs(title = "Sacramento Average Temperature Anomaly", x = "Years", y = "Average Anomaly") #+ 
...
ggsave("test.png", width = 10, height = 3)
```
...
```{r}
ggplot(full_raw, aes(x = as.factor(Month) ,  y = Temps)) + geom_boxplot()
